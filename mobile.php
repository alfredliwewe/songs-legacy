...
$first_launch = $db->query("SELECT * FROM first_launch WHERE user = '$user_id_cookie' ")->num_rows == 0;
?>
<!DOCTYPE html>
<html>
<head>
...
<script type="text/javascript">
    var first_launch = <?= $first_launch?"true":"false";?>;
...
$files = [
    ...
    'mobile/SongsDisplay.jsx',
    'mobile/ComposeComment.js',
    'mobile/LoginForm.jsx',
    'mobile/PlayerBottom.jsx'
];
