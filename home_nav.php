...
<div class="w3-modal" id="nav_mobile_modal" style="padding-top: 0px;background: rgba(255,255,255,0.01) !important;">
	<div class="w3-modal-content w3-animate-right" style="width: 100%;margin: 0px !important;">
		...
		<div class="bg w3-padding-jumbo">
			<a href="../" class="w3-btn w3-block bg w3-text-white w3-padding-xlarge w3-border-bottom w3-border-grey w3-large bold" style="text-align:left;"><?php echo $languages[$language]['home'];?></a><a onclick="$('#nav_mobile_modal').hide();$('#results_container').show();$('#top_search').focus();" class="w3-btn w3-text-white w3-block w3-padding-xlarge w3-border-bottom w3-border-white w3-large bold" style="text-align:left;"><?php echo $languages[$language]['search'];?> <i class="fa fa-search"></i></a><a href="signin/" class="w3-btn bg w3-text-white w3-block w3-padding-xlarge w3-border-bottom w3-border-grey w3-large bold" style="text-align:left;"><?php echo $languages[$language]['login'];?></a>
		</div>
	</div>
</div>
